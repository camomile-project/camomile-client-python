...
if __name__ == '__main__':
    ...
    layer1 = root_client.add_layer(corpus1['_id'], data)
    ...
    for i in range(10):
        ...
        media = root_client.add_media(corpus1['_id'], data)
    ...
    for id_media in l_id_media:
        for i in range(3):
            ...
            annotation = root_client.add_annotation(layer1['_id'], data)
    ...
    annotation = root_client.update_annotation(l_annotation[0]['_id'], data)
    print json.dumps(annotation, indent=2, sort_keys=True)

    # create layer with annotations in 1 request
    data_layer = {"name":"speaker_id_multi_sup2", "fragment_type":"id_mediasegment", "data_type":"name", 'annotations':[]}
    ...
    l_speaker_id_multi_sup = root_client.add_layer(corpus1['_id'], data_layer)
